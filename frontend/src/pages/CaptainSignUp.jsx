...
const CaptainSignUp = () => {
  ...
  return (
    <div className='p-7 h-screen flex flex-col justify-between' >
      <div>
        <img className="w-35 ml-2" src={captainLogo} alt="Logo" />
        ...
        <p className='text-center text-base'>Already have an account? <Link to='/captain-login' className='text-orange-500'>Login here</Link></p>
      </div>
